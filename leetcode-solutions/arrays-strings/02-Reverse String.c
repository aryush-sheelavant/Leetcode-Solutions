...
int main() {
    ...
    char s1[] = {'h','e','l','l','o'};
    int size1 = 5;
    printf("Test 1 Original: "); printArray(s1, size1);
    reverseString(s1, size1);
    printf("Test 1 Reversed: "); printArray(s1, size1);
    printf("\n");

    // Test Case 2: Even-length array (Edge case)
    char s2[] = {'H','a','n','n','a','h'};
    int size2 = 6;
    printf("Test 2 Original: "); printArray(s2, size2);
    reverseString(s2, size2);
    printf("Test 2 Reversed: "); printArray(s2, size2);
